...
public class MyToken {
            ...
            static String twilioAccountSid = rIni.run("tw.ini")[0];
            ...
            static String twilioApiKey = rIni.run("tw.ini")[1];
                            //"SK67b3261c54340bfb6c2d096fdaab6caf";
            ...
            static String twilioApiSecret = rIni.run("tw.ini")[2];
                                    //"SljuHuKxhsUK9ywPXDMF6DvQr4b802e4";
            ...
            static String serviceSid = rIni.run("tw.ini")[3];
                                            //"MG265ed3f71dd6f4acf513ac02ee667211";
            ...
            public static String newToken(String userid, String deviceId ) {
                ...
                //System.out.println(twilioAccountSid+" "+twilioApiKey+" "+twilioApiSecret);
